...
find testResults -name "*.tab"  -type f -printf '%f\n'| xargs -I {} diff -q testResults/{} refTestResults/{}
rexe=$?
find testResults -name "*.txt"  -type f -printf '%f\n'| xargs -I {} diff -q testResults/{} refTestResults/{}
rexe=$(($?+$rexe))
find testResults -name "*.vtu"  -type f -printf '%f\n'| xargs -I {} diff -q testResults/{} refTestResults/{}
rexe=$(($?+$rexe))
find testResults -name "*.vtp"  -type f -printf '%f\n'| xargs -I {} diff -q testResults/{} refTestResults/{}
rexe=$(($?+$rexe))
